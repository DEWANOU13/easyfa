<x-action-section>
  ...
  <x-slot name="content">
    ...
    <x-dialog-modal wire:model.live="confirmingLogout" class="flex items-center">
      <x-slot name="title">
        {{ __('Se déconnecter des autres sessions du navigateur') }}
      </x-slot>
      ...
      <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
          <x-input type="password" class="mt-1 block w-3/4" autocomplete="current-password" placeholder="{{ __('Mot de passe') }}" x-ref="password" wire:model="password" wire:keydown.enter="logoutOtherBrowserSessions" />
