@forelse ($groupes as $groupe)
    <tr>
        ...
        <td scope="row">{{ $groupe->nom_groupe }}</td>
        <td scope="row">{{ $groupe->description }}</td>
        <td>
            <div class="d-flex gap-2 w-100 justify-content-end">
                <a href="{{ route('groupe.edit', $groupe) }}" class="btn btn-primary" title="editer" data-toggle="tooltip">
