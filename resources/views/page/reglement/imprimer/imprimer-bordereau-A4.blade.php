...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">BORDEREAU DU REGLEMENT</div>
    <br>
                ...
                <fieldset class="border p-3 rounded-3" style="border-radius: 5px;">
                    ...
                    <table class="tableInfo">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight: bold; font-style: italic; vertical-align: top;">Client&nbsp;:
                                </td>
                        ...
                        @foreach ($detail_reglements as $detail_reglement)
                            @if ($item->id === $detail_reglement->Id_Reglement)
                                <tr>
                                    ...
                                    <td>{{ number_format(intval($detail_reglement->Montant_Regle), 0, ',', ' ') }}</td>
                                </tr>
                            @endif
                            @php
