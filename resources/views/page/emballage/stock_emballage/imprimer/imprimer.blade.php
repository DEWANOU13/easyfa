...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">LISTE DES STOCKS EMBALLAGES</div>
    <br>
    ...
    <div class="table">
        <table class="tableLigne">
            <thead>
                ...
                <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte en stock</th>
              </thead>
              <tbody>
                @php
                $totalStock = 0;
