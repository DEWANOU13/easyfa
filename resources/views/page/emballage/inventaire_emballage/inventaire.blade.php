...
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Inventaires emballages',
        'infos2' => 'Inventaires emballages',
        'infos3' => 'Liste',
    ])
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="z-index: 2000;">
                        @can('effectuer-inventaire')
                            <li><a href="{{ route('inventaire_emballage_nouveau') }}" class="dropdown-item"
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                        ...
                        @can('voir-impression-inventaire-emballage')
                    ...
                    <div class="row mt-4 mb-5">
                        <div class="col-md-2 border">
                            <form class="d-flex align-items-center mt-2" id="filterForm"
                             action="{{ route('filterInventaireEmballage') }}" method="GET">
                            <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste des inventaires emballages</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody>
                                                @forelse($inventaire_emballages as $inventaire_produit)
                                                    <tr style="cursor:pointer" class="clickable-row" id="2"
                                                        data-url="{{ route('get.inventaire_magasin_for_inventaire_emballage', ['id' => $inventaire_produit->id]) }}">
                                                        <td>
                                    ...
                                    <div class="table-responsive responsive-1">
                                        <div class="col-md-12">
                                            <table class="tableInfo tableInfo2" id="magasintable"
                                                ...
                                                <tbody>
                                                    @if (isset($inventaire_magasin_emballages))
                                                    @forelse($inventaire_magasin_emballages as $inventaire_magasin)
                            ...
                            <div class="card m-b-30 my-3">
                                ...
                                <div class="card-body">
                                    <form id="formcreate" action="{{ route('modifier_inventorier_emballage') }}" method="post">
                                                ...
                                                <table class="tableInfo dataTable tableInfo-green tableInfo2"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="inputs[{{ $index }}][ecart]"
                                                            ...
                                                            <td><input name="inputs[{{ $index }}][justifiee]"
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row mt-4 d-flex justify-content-center">
                        <div class="col-md-8 mb-5">
                            ...
                            <form class="row gx-3 gy-2" action="{{ route('impimer_inventaire_emballage') }}" target="_blank"
                                method="POST">
                                @csrf
                                <div class="col-sm-12">
                                    <div class="form-check">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <select type="text" name="reference_inventaire" class="form-select"
                                                ...
                                                @foreach ($inventaire_emballages as $inventaire_produit)
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#modifierBtn').click(function() {
                ...
                if (selectedId !== 'on') {
                    $.ajax({
                        url: "{{ route('modifier_statut_inventaire_emballage') }}",
                        type: "GET",
                        data: {
                            id: selectedId
                        },
