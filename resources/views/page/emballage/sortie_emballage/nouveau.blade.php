...
'infos1' => 'Nouvelle sortie emballage',
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <div class="table-responsive mt-3">
                <div class="col-md-12">
                    <form id="formcreate" action="{{ route('store_sortie_emballage') }}" method="post" id="myForm">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3">
                                    <legend class="float-none w-auto px-1">Type de sortie</legend>

                                    <div class="form-group col-md-4">
                                        <label class="form-label fw-bold position-relative" for="">Type
                            ...
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3">
                                    <legend class="float-none w-auto px-1">Observation</legend>
                                    <div class="row">
                                ...
                                <fieldset class="border p-3 rounded-3" id="table">
                                    ...
                                    <div class="row">
                                        <table class="table border-0">
                                            <div class="form-group col-md-4">
                                                <label class="form-label fw-bold" for="">Emballage</label>
            ...
            function updateOrAddRow(reference, designation, magasin, quantite, quantity_out) {
                ...
                if (rowToUpdate !== null) {
                    ...
                    var newRow = `<tr>
                            ...
                            <td>
                                <div class="input-group input-group-sm mb-3">
                                    <input type="text" name="inputs[${rowCount}][designation]" class="form-control border-0" value="${designation}" readonly>
                                </div>
                            </td>
                            <td>
                                <div class="input-group input-group-sm mb-3">
                            ...
                            <td>
                                <div class="input-group input-group-sm mb-3">
                                    <input type="number" name="inputs[${rowCount}][quantity_out]" class="form-control border-0" id="quantity_out" value="${quantity_out}" readonly>
                                </div>
                            </td>
                            <td>
