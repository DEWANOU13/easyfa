@extends('layouts.master', ['title' => 'Sorties Emballage'])
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Sortie Emballage',
        'infos2' => 'Sortie Emballage',
        'infos3' => 'Liste',
    ])
    {{-- @section('content') --}}
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="z-index: 2000;">
                        @can('effectuer-sortie-produit')
                            <li><a href="{{ route('sortie_nouveau') }}" class="dropdown-item"
                                    type="button">Nouveau</a></li>
                        @endcan
                        @can('exporter-excel-sortie-emballage')
                            <form action="{{ route('imprimer_sortie_emballage') }}" method="POST" target="_blank">
                                @csrf
                                <input type="hidden" id="value" name="id_sortie">
                                <li><button class="dropdown-item" value="imprimer" name="reponse"  type="submit" id="imprimer-button">Imprimer</button>
                                <li><button class="dropdown-item" value="exporter" name="reponse" type="submit" id="imprimer-button">Exporter</button>
                                </li>
                            </form>
                        @endcan
                    </ul>
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                        ...
                        @can('voir-impression-sortie-emballage')
            ...
            <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row mt-4 mb-5">
                        <div class="col-md-2">
                            <div class="row border">
                                ...
                                action="{{ route('filterSortieEmballage') }}" method="GET">
                               <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste des sorties d'emballage</h3>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($sortie_produits as $sortie_produit)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('getSortirEmballage', ['id' => $sortie_produit->id]) }}">
                                    ...
                                    <div class="table-responsive responsive responsive-1 ">
                                        <div class="col-md-12">
                                            <table
                                                ...
                                                <thead class="table-primary">
                                                    <tr>
                                                        <th style="" scope="col">Référence emballage</th>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row mt-1 d-flex justify-content-center">
                        <div class="col-md-8">
                            <h3>LISTE DES SORTIES EMBALLAGE EN STOCK SUR UNE PERIODE</h3>
                            <form class="row gx-3 gy-2 mb-5" action="{{ route('imprimerlisteSortieEmballage') }}" target="_blank" method="POST">
                                @csrf
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="magasin" type="text" class="form-select js-single" style="width: 100%" id="magasin">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="categorie" type="text" class="form-select js-single" style="width: 100%" id="categorie">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select name="produit" type="text" class="form-select js-single" style="width: 100%" id="produit">
