@extends('layouts.master', ['title' => 'Transfert emballage'])
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Transfert emballage',
        'infos2' => 'Transfert emballage',
        'infos3' => 'Liste',
    ])
                    ...
                    <ul class="dropdown-menu" style="z-index: 2000;">
                        @can('effectuer-transfert-produit')
                            <li><a class="dropdown-item" type="button"
                                    href="{{ route('transfert_nouveau_emballage') }}">Nouveau</a></li>
                        @endcan
                        @can('imprimer-liste-transfert')
                            <form action="{{ route('transfert_emballage-imprimer') }}" method="POST" target="_blank">
                                @csrf
                                            ...
                                            <tbody>
                                                @forelse($transfert_produits as $transfert_produit)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('getTransfertEmballage', ['id' => $transfert_produit->id]) }}">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            ...
                            <form class="row gx-3 gy-2 pb-4" method="POST" action="{{ route('transfertEmballagePeriode') }}"
                                target="_blank">
                                @csrf
                                <div class="col-sm-6">
