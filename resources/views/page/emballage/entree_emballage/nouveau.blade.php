...
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Entrée emballage',
        'infos2' => 'Entrée emballage',
        'infos3' => 'Nouveau',
    ])
    ...
    <section>
        ...
        <form id="creeEntreeForm" class="" action="{{ route('store_entree_emballage') }}" method="post" class="my-5">
            @csrf
            @if ($errors->any())
                    ...
                    <fieldset class="border p-3 rounded-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <select name="fournisseur" type="text" class="form-select js-single" id="fournisseur" required
                        ...
                        <div class="row">
                            <table class="table mt-4 border-0">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="" type="text" class="form-select produit-select js-single" id="produit"
                                ...
                                <div class="form-group col-md-4">
                                    <label class="form-label fw-bold" for="">Référence  Emballage</label>
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <fieldset class="border p-3 rounded-3">
                        <legend class="float-none w-auto px-1">Ligne entrée emballage</legend>
                        <!-- Modal -->
