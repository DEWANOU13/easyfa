@extends('layouts.master', ['title' => 'Entrées emballage'])
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Entrées emballage',
        'infos2' => 'Entrées emballage',
        'infos3' => 'Liste',
    ])
    <style>
        .overflow-container {
    ...
    <div class="row d-flex text-start p-3">
        <div class="col text-end">
            @canany(['effectuer-entrer-produit', ''])
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="z-index: 2000;">
                        @can('effectuer-entrer-produit')
                            <li><a class="dropdown-item" type="button" href="{{ route('entree_nouveau_emballage') }}">Nouveau</a>
                            </li>
                        @endcan
                        <form action="{{ route('imprimer_entree_emballage') }}" method="POST" target="_blank">
                            @csrf
                            <input type="hidden" id="value" name="id_entree">
                            @can('exporter-excel-entre-emballage')
                                <li><button class="dropdown-item" type="submit" id="imprimer-button" name="reponse"
                                        value="exporter">Exporter</button></li>
                                </li>
                            @endcan

                            @can('exporter-pdf-entre-emballage')
                                <li><button class="dropdown-item" type="submit" id="imprimer-button" name="reponse"
                                        value="imprimer">Imprimer</button></li>
                            @endcan
                ...
                <div class="modal fade" id="importerStock" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form id="formimport" action="{{ route('import.emballage') }}" method="POST"
        ...
        <div class="col-md-12">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    @can('voir-impression-entree-emballage')
                    ...
                    <div class="row mt-4 mb-5">
                        <div class="col-md-2 border">
                            <form class="d-flex align-items-center mt-2" id="filterForm"
                                action="{{ route('filterEntreeEmballage') }}" method="GET">
                                <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste des entrées emballages</h3>
                                </div>
                                                ...
                                                @if (isset($entree_produits))
                                                    @forelse($entree_produits as $entree_produit)
                                                        <tr style="cursor:pointer" class="clickable-row"
                                                            data-url="{{ route('getEntrerEmballage', ['id' => $entree_produit->id]) }}">
                            ...
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Détails des entrées emballages</h3>
                                </div>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row mt-4 d-flex justify-content-center">
                        <div class="col-md-8 mb-5">
                            ...
                            <form class="row gx-3 gy-2" action="{{ route('imprimer_entree_emballage') }}"
                                method="POST">
                                @csrf
                                <div class="col-sm-6">
