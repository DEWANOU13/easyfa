                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="z-index: 2000;">
                        @can('effectuer-transfert-produit')
                            <li><a class="dropdown-item" type="button" href="{{ route('nouveau_reception_approvissionner') }}">Nouveau</a>
                            </li>
                        @endcan
                                                    ...
                                                    @if (isset($receptionners))
                                                        @forelse($receptionners as $receptionner)
                                                            <tr style="cursor:pointer" class="clickable-row">
                                                                ...
                                                                <td class="entree-produit"> {{ $receptionner->Qte_Receptionnee }}</td>
                                                            </tr>
                                                        @empty
                                                        @endforelse
                                                    @endif
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            ...
                            <form class="row gx-3 gy-2 pb-4" method="POST" action="{{ route('reception_approv_impression') }}"
                                target="_blank">
                                @csrf
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="agence" type="text" class="form-select"
                                        id="magasin_source">
