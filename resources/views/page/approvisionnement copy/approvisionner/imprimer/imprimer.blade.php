...
<body>
    ...
    <section class="">
            ...
            <div class="titre" style="padding-top: 20px;">APPROVISIONNEMENT</div>
            ...
            <div>
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                    ...
                    <div  style="display: flex; align-items: center; justify-content: space-between; width: 100%; margin-top: 20px;">
                        ...
                        <div>
                            <span style=" margin-top: 30px; font-style: italic; vertical-align: top; border:#333 solid 1px; padding: 5px; border-radius: 5px; padding-left: 10px; box-shadow: 3 5px 10px rgba(0, 0, 0, 0.1); background-color: #f2f2f2"><strong>&nbsp; Nom Agence Detsination:</strong> {{ $item->NomAgence }}</span>
                        </div>
