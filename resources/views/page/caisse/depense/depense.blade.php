            ...
            <div class="col text-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a type="button" class="dropdown-item" href="{{ route('new_depense') }}">Nouvelle dépense</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"
                    ...
                    <div class="row mt-4 mb-5">
                        ...
                        <div class="col-md-10">
                                            ...
                                            <tbody>
                                                @forelse ($listeCaisse as $caisse)
                                                    <tr style="cursor:pointer;" class="clickable-row "
                                                        data-url="{{ route('getDetailCaisse2', ['id' => $caisse->id]) }}">
                            ...
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Historique dépense de la caisse</h3>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse ($detailCaisse as $detail)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($detail->statut_caisse == '1')
                                                                <button type="button"
                                                                    class="btn btn-outline-danger btn-sm"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#exampleModal{{ $detail->id }}">
                                                                    Annuler
                                                                </button>

                                                                <div class="modal fade"
                                                                    id="exampleModal{{ $detail->id }}" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form action="{{ route('annulerDepense') }}"
                                                                                method="POST"
                                                                                id="annulerDepenseForm{{ $detail->id }}">
                                                                                <div class="modal-body">
                                                                                    Voulez-vous vraiment annuler la depense
                                                                                    ?
                                                                                    @csrf
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        <label
                                                                                            ...
                                                                                            class="form-label">Justification</label>
