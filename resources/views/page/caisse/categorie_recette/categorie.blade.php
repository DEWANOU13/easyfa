@extends('layouts.master', ['title' => 'Categorie recette'])

@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Catégorie Recette',
        'infos2' => 'Catégorie Recette',
        'infos3' => 'Liste',
    ])

    @canany(['creer-categorie-recette', 'modifier-categorie-recette'])
            ...
            <div class="col text-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('modifier-categorie-recette')
                            <li>
    ...
    <div class="card m-b-30" wire:ignore>
        <div class="card-header" style="{{ background_color_2() }}">
            <h3 class="mt-2 d-inline-block text-dark">Liste des catégories de recette</h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="magasinsTable" class="datatable table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        @foreach ($listeCatRecettes as $key => $item)
    ...
    <div class="modal fade" id="creeCatEmballage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="creeEmballageForm" action="{{ route('storeCatRecette') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="creeCatEmballageLabel">Nouvelle catégorie recette</h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="creeLibelle" class="form-label fw-bold">Désignation <span
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="statut" value="1" required
                                        id="creeActif">
    ...
    <!-- Modal Modifier -->
    <div class="modal fade" id="modifierCatEmballage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="modifierCatEmballageLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="modifierEmballageForm" action="{{ route('updateCatRecette') }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modifierCatEmballageLabel">Modifier catégorie recette</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="modifierLibelle" class="form-label fw-bold">Désignation <span
                                            class="fs-5 text-danger mb-2">*</span></label>
                                    <input type="text" name="designation" id="modifierLibelle" class="form-control"
                                        required>
                                    <div class="invalid-feedback">Le champ est obligatoire</div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#modifierCatEmballageButton').on('click', function() {
                ...
                if (selectedRow.length > 0) {
                    ...
                    var categorieStatut = selectedRow.find('td').eq(4).find('i').hasClass('text-success') ?
                        1 : 0;
