...
@section('content')
    @include('layouts.partials.entete-page', [
        ...
        <section>
            <form id="formcreate" action="{{ route('storeRecette') }}" method="post">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="card-body">
                        <fieldset class="border p-3 rounded-3">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="validationTextarea" class="form-label fw-bold position-relative">Categorie recette
                                        <span
                                            class="position-absolute top-0 start-100 translate-middle p-2 text-danger ms-1 mt-2">*
                                        </span>
                                    </label>
                                    ...
                                    <div class="input-group input-group-md mb-3">
                                        <select name="categorie_recette_id" type="text" class="form-select js-single" id="consignation_imput"
                                            required>
                                            <option value="">Sélectionnez</option>
                                            @foreach ($listeCategorieRecette as $key => $value)
