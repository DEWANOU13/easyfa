@extends('layouts.master', ['title' => 'Categorie dépense'])

@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Catégorie Dépense',
        'infos2' => 'Catégorie Dépense',
        'infos3' => 'Liste',
    ])
    ...
    <div class="card m-b-30" wire:ignore>
        <div class="card-header" style="{{ background_color_2() }}">
            <h3 class="mt-2 d-inline-block text-dark">Liste des catégories de dépense</h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="magasinsTable" class="datatable table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        @foreach ($listeCatDepenses as $key => $item)
                            <tr class="clickable-row" data-id="{{ $item->id }}">
                                <td>{{ $key + 1 }}</td>
                                <td class="magasin-nom">{{ $item->designation }}</td>
                                <td class="magasin-nom">{{ $item->Enregistrer_par }}</td>
                                <td class="magasin-nom">{{ $item->Modifier_par }}</td>
                                <td>
                                    @if ($item->statut == 1)
    ...
    <div class="modal fade" id="creeCatEmballage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="creeCatEmballageLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="creeEmballageForm" action="{{ route('storeCatDepense') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="creeCatEmballageLabel">Nouvelle catégorie dépense</h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="creeLibelle" class="form-label fw-bold">Désignation <span class="fs-5 text-danger mb-2">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="statut" value="1" required id="creeActif">
                                    <label class="form-check-label" for="creeActif">Actif</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="statut" value="0" id="creeInactif">
    ...
    <div class="modal fade" id="modifierCatEmballage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modifierCatEmballageLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="modifierEmballageForm" action="{{ route('updateCatDepense') }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modifierCatEmballageLabel">Modifier catégorie dépense</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="modifierLibelle" class="form-label fw-bold">Désignation <span class="fs-5 text-danger mb-2">*</span></label>
                                    <input type="text" name="designation" id="modifierLibelle" class="form-control" required>
                                    <div class="invalid-feedback">Le champ est obligatoire</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="statut" value="1" required id="modifierActif">
                                    <label class="form-check-label" for="modifierActif">Actif</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="statut" value="0" id="modifierInactif">
