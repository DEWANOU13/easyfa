...
<body>
    ...
    <div class="titre" style="">LISTE DES CATEGORIES DE CLIENT</div>

    <table class="tableLigne">
        <thead>
            <tr>
                <th style="width: 10px;background-color: #3232df;color: white;">Numero</th>
                <th style="width: 50px;background-color: #3232df;color: white;">Categorie Client</th>
                <th style="width: 50px;background-color: #3232df;color: white;">Enregistrée par </th>
                <th style="width: 150px;background-color: #3232df;color: white;">Modifiée par</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($data['tableCategorieClientData'] as $categorieClient)
                <tr>
                    <td>{{ $categorieClient['numero'] }}</td>
                    <td>{{ $categorieClient['categorie_client'] }}</td>
                    <td>{{ $categorieClient['enregistre_par'] }}</td>
                    <td>{{ $categorieClient['modifie_par'] }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
