...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">LISTES DES FOURNISSEURS </div>
    <br>
    ...
    <div class="table" style="margin-top: 15px;">
        <table class="tableLigne">
            <thead>
                <th style="width: 10px;background-color: #3232df;color: white;">Denomination Sociale</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Adresse Fournisseur</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Telephone Fixe</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Telephone Mobile</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Adresse mail</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Pays</th>
                <th style="width: 10px;background-color: #3232df;color: white;">Numéro IFU</th>
            </thead>
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        <td>{{ $item->DenominationSociale }}</td>
                        <td>{{ $item->AdresseFournisseur }}</td>
                        <td>{{ $item->TelephoneFixe }}</td>
                        <td>{{ $item->TelephoneMobile }}</td>
                        <td>{{ $item->AdresseMail }}</td>
                        <td>{{ $item->Pays }}</td>
                        <td>{{ $item->NumeroIfu }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
