...
<body>
    ...
    <div class="titre" style="">ETAT DE COMPTE</div>
            ...
            <table class="tableInfo">
                <tbody>
                    <tr>
                        ...
                        <td>{{ $data['clientRecherche'] }}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold; font-style: italic; vertical-align: top;">Date&nbsp;:</td>
                        <td>{{ $data['debut_periode'] }} au {{ $data['fin_periode'] }}</td>
                    </tr>
                    <tr>
    ...
    <table class="tableLigne">
        <thead>
            <tr>
                <th width="75px" style="background-color: #3232df;font-weight: bold; color: white; ">
                    Date</th>
                <th width="75px" style="background-color: #3232df;font-weight: bold; color: white; ">
                    Client</th>
                <th width="75px" style="background-color: #3232df;font-weight: bold; color: white; ">
        ...
        <tbody>
            @foreach ($data['clientsTableData'] as $row)
                <tr>
                    <td>{{ $row['date'] }}</td>
                    <td">{{ $row['client'] }}</td>
                    <td">{{ $row['operation'] }}</td>
