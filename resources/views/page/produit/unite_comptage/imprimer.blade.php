...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">LISTES DES UNITES COMPTAGES</div>
    <br>
    {{-- @foreach ($entree_produits as $entree_produit) --}}
        ...
        <div class="table" style="margin-top: 15px;">
            <table class="tableLigne">
                <thead>
                    <th style="background-color: #3232df;font-weight: bold; color: white; ">Libelle</th>
                    <th style="background-color: #3232df;font-weight: bold; color: white; ">Code</th>
                    <th style="background-color: #3232df;font-weight: bold; color: white; ">Date création</th>
                </thead>
                <tbody>
                    @foreach ($unite_comptages as $item)
                        <tr>
                            <td>{{ $item->Libelle }}</td>
                            <td>{{ $item->Code }}</td>
