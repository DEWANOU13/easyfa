...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">LISTE DES STOCKS</div>
    <br>
            ...
            <div>
                <span
                    style=" margin-top: 30px; font-style: italic; vertical-align: top; border:#333 solid 1px; padding: 5px; border-radius: 5px; padding-left: 10px; box-shadow: 3 5px 10px rgba(0, 0, 0, 0.1); background-color: #f2f2f2"><strong>&nbsp;
                        Nom Emballage:</strong> {{ $item_categorie->Libelle }}</span>
            </div>
        </div>
        <br>
        <div class="table">
            <table class="tableLigne mb-5">
                <thead>
                    ...
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Unite de
                        comptage</th>
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Magasin
                    </th>
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte en
                        stock
                    </th>
                </thead>
                <tbody>
                    ...
                    @foreach ($getStock as $value)
                        @if ($value->Emballage_id === $item_categorie->Emballage_id)
                            <tr>
    ...
    <div style="text-align: right; margin-top: 15px;">
        <h4>Exporté par : {{ $authUserName }}</h4>
        <h4>{{ \Carbon\Carbon::now()->format('d/m/Y à H:i:s') }}</h4>
    </div>
