...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">HISTORIQUE DU STOCK</div>
    <br>
        ...
        <table class="tableLigne">
            <thead>
                <tr>
                    ...
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Agence</th>
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Référence</th>
                    ...
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Motif</th>
                    <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Produit</th>
