...
<table>
    <tr>
        <td colspan="6" style="font-weight: bold; font-size: 15px; background-color: #3232df; text-align: center; color: white;">{{$texteEntetePied->entete}}</td>
    </tr>
</table>
@endif
<table>
    ...
    <table>
        <thead >
            <tr style="padding: 8px; border: 1px solid black; ">
                ...
                <th width="300px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Unité comptage</th>
    ...
    <table>
        ...
        <tr>
            <td colspan="6" style="font-weight: bold;text-align: right;">{{\Carbon\Carbon::now()->format('d/m/Y à H:i:s')}}</td>
        </tr>
    </table>
...
<table>
    <tr>
        <th style="font-weight: bold">reference_produit</th>
        <th style="font-weight: bold">nom_produit</th>
        <th style="font-weight: bold">Catégorie</th>
