...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">BORDEREAU DE SORTIE</div>
    <br>
    @foreach ($sortie_produits as $sortie_produit)
                    ...
                    <table class="tableInfo">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight: bold; font-style: italic; vertical-align: top;">
                                    Observations&nbsp;:</td>
                                <td>{{ $sortie_produit->Observations }}</td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold; font-style: italic; vertical-align: top;">
                                    Enregistrer par&nbsp;:
        ...
        <div style="margin-top: 0px;">
            <div style="margin-bottom: 10px;">
                <span style="font-weight: bold; font-size: 14px">Type sortie: {{ $sortie_produit->type_sortie }}</span>
            </div>
        </div>
        <br>
