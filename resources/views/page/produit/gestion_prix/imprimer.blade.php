...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">LISTES GESTIONS PRIX</div>
    <br>
    ...
    <div class="table" style="margin-top: 15px;">
        <table class="tableLigne">
            <thead>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Réference</th>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Désignation</th>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Catégorie Produit</th>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Agence</th>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Catégorie par client</th>
                <th style="background-color: #3232df;font-weight: bold; color: white; ">Prix de vente HT</th>
            </thead>
            <tbody>
                @foreach ($gestions_prix as $getPrix)
                    <tr>
                        <td>{{ $getPrix->Reference }}</td>
                        <td>{{ $getPrix->Designation }}</td>
                        <td>{{ $getPrix->Libelle_produit }}</td>
                        <td>{{ $getPrix->NomAgence }}</td>
                        <td>{{ $getPrix->Libelle_client }}</td>
                        <td>{{ number_format(intval($getPrix->prix ), 0, ',', ' ') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
