@extends('layouts.master', ['title' => 'Gestion Prix'])

@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Gestion de prix',
        'infos2' => 'Gestion de prix',
        'infos3' => 'Liste',
    ])

    @livewire('gestion-prix.nouveau-gestion-prix', [
        'produits' => $produits,
        'historique_prix_revients' => $historique_prix_revients,
        'categorie_client' => $categorie_client,
        'agence' => $agence,
        'historique_prix_ventes' => $historique_prix_ventes,
    ])
    <style>
        .selected>td {
