...
<body>
    ...
    @foreach ($transfert_produits as $transfert_produit)
                    ...
                    <table class="tableInfo">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($transfert_produit->Date_Transfert)->format('d/m/Y H:i') }}
                                </td>
                            </tr>
                            <tr>
        ...
        <br>
        @foreach ($data_categorie_transfert as $item_categorie)
            <div style="margin-top: 0px;">
                <div>
                    <span
                        style=" margin-top: 30px; font-style: italic; vertical-align: top; border:#333 solid 1px; padding: 5px; border-radius: 5px; padding-left: 10px; box-shadow: 3 5px 10px rgba(0, 0, 0, 0.1); background-color: #f2f2f2"><strong>&nbsp;
                            Catégorie produit:</strong> {{ $item_categorie->Libelle }}</span>
                </div>
            </div>
                ...
                <table class="tableLigne">
                    ...
                    <tbody>
                        ...
                        @foreach ($transferers as $value)
                            @if ($value->Id_Categorie === $item_categorie->Id_Categorie)
                                <tr>
                                ...
                                @php
                                    $totalStock += $value->Qte_transferee;
                                @endphp
                            @endif
                        @endforeach
    ...
    <div style="text-align: right; margin-top: 15px;">
        <h4>Exporté par : {{ Auth::user()->name }}</h4>
