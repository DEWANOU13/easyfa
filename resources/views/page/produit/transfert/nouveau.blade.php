...
@section('content')
    ...
    @include('layouts.partials.entete-page', [
        'infos1' => 'Nouveau Transfert',
        'infos2' => 'Nouveau Transfert',
        'infos3' => 'Liste',
    ])

    <div class="d-flex flex-row-reverse bd-highlight">
        <div class="dropdown mb-2">
            <a href="{{ route('page.transfert.transfert') }}" class="btn text-white" style="{{ background_color_1() }}">
    ...
    <div class="row mt-2 mb-5">
        <div class="col-md-12">
            ...
            <div class="table-responsive mt-3">
                <div class="col-md-12">
                    <form action="{{ route('store.transfert') }}" method="post" id="myForm">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3">
                                    <legend class="float-none w-auto px-1">Magasin</legend>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="form-label fw-bold" for="magasin_source">Magasin source</label>
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                <select name="magasin_source" type="text" class="form-select js-single"
                                                    ...
                                                    @foreach ($magasin_source as $key => $magasin)
                                        ...
                                        <div class="form-group col-sm-12">
                                            <label class="form-label fw-bold" id="magasin_destination">Magasin de
                                                destination</label>
                                                <span class="translate-middle text-danger mt-2">*
                                                </span>
                                            <div class="input-group input-group-sm mb-3">
                                                <select name="magasin_destination" type="text" class="form-select magasinCreateimput js-single"
                                                    ...
                                                    @foreach ($magasin_destination as $key => $magasin)
                                                        <option value="{{ $magasin->id }}">
                                                            {{ $magasin->NomMagasin }} ==> {{ $magasin->NomAgence }}
                                                        </option>
                                                    @endforeach
                            ...
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3" id="table">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-2">
                                            <label class="form-label fw-bold" for="quantity_transfer">Quantité
                                                Transférée</label>
                                            <div class="input-group input-group-sm mb-3">
                                                <input min="0" type="number" name="" class="form-control"
                                                    placeholder="Qté à transférer..."
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3" id="table">
                                    <legend class="float-none w-auto px-1">Détails transferts</legend>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="" class="fw-bold">Total Nombre Qté à tranférer</label>
                                            <input class="form-control border-0" type="text" id="prixAchatTotal"
                                                readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" class="fw-bold">Nombre à tranférer</label>
            ...
            function updateOrAddRow(reference, designation, magasin, quantite, quantity_transfer) {
                ...
                if (rowToUpdate !== null) {
                    ...
                    var newRow = `<tr>
                            ...
                            <td>
                                <div class="input-group input-group-sm mb-3">
                                    <input style="width: 250px;" type="number" name="inputs[${rowCount}][quantity_transfer]" class="form-control border-0" id="quantity_transfer" value="${quantity_transfer}" readonly>
                                </div>
                            </td>
                            <td>
