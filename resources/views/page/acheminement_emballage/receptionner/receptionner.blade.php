@extends('layouts.master', ['title' => 'Réceptionner Acheminement'])
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Réceptionner Acheminement emballage',
        'infos2' => 'Réceptionner Acheminement emballage',
        'infos3' => 'Liste',
    ])
        ...
        <div class="col text-end">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" style="z-index: 2000;">
                    @can('receptionner-acheminement-emballage')
                        <li><a class="dropdown-item" type="button"
                                href="{{ route('nouveau_reception_acheminement_emballage') }}">Nouveau</a>
                        </li>
                    @endcan
                    <form action="{{ route('reception_imprimer_actiont_emballage') }}" method="POST" target="_blank">
                        @csrf
                        <input type="hidden" id="value" name="id_reception">
                        ...
                        <div class="col-md-2">
                            <div class="row border">
                                <form class="d-flex align-items-center mt-2" id="filterForm"
                                    action="{{ route('filterReceptionAchminementEmballage') }}" method="GET">
                                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste réception des Acheminements d'emballage
                                    </h3>
                                </div>
                                <div class="card-body responsive-2">
                                    <div class="table-responsive">
                                        <table id="proformaTable"
                                            ...
                                            <tbody>
                                                @forelse($listeReception as $reception)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('getReceptionLignet_emballage', ['id' => $reception->id]) }}">
                            ...
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Détails réceptions acheminement</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive responsive-1">
                                        <div class="col-md-12">
                                            <table id=""
                                                ...
                                                <tbody>
                                                    @if (isset($receptionner_acheminements))
                                                        @forelse($receptionner_acheminements as $receptionner)
                                                            <tr style="cursor:pointer" class="clickable-row">
                                                                <td class="entree-produit">
                                                                ...
                                                                <td class="entree-produit">
                                                                    {{ $receptionner->Qte_acheminee }}
                                                                </td>
                                                                <td class="entree-produit">
                                                                    {{ $receptionner->Qte_Receptionnee }}
                                                                </td>
                                                            </tr>
                                                        @empty
                                                        @endforelse
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            <h3>LISTE DES ACHEMINEMENTS EMBALLAGE SUR UNE PERIODE</h3>
                            <form class="row gx-3 gy-2 pb-4" method="POST"
                                action="{{ route('imprimer_reception_emballage') }}" target="_blank">
                                @csrf
                                <div class="col-sm-6">
