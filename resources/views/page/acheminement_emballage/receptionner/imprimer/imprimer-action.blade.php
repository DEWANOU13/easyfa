...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">BORDEREAU RECEPTION ACHEMINEMENT EMBALLAGE</div>
    <br>
    ...
    <div class="clearfix" style="margin-bottom: 20px">
                ...
                <table class="tableInfo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($item->Date_Reception)->format('d/m/Y H:i') }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; font-style: italic; vertical-align: top;">
                            Reférence&nbsp;:</td>
                            <td>{{ $item->Reference_Reception }}</td>
                        </tr>
                        <tr>
        ...
        <div style="margin-top: 0px;">
            <div style="margin-bottom: 10px;">
                 <span style="font-weight: bold;">Observations: {{ $item->Observations }}</span>
            </div>
        </div>
        <br>
