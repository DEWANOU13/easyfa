@extends('layouts.master', ['title' => 'Acheminement'])
@section('content')
    ...
    @include('layouts.partials.entete-page', [
        'infos1' => 'Nouveau acheminement emballage',
        'infos2' => 'Nouveau acheminement emballage',
        'infos3' => 'Nouveau',
    ])

    <div class="d-flex flex-row-reverse bd-highlight">
        <div class="dropdown mb-2">
            <a href="{{ route('acheminer_emballage') }}" class="btn text-white" style="{{ background_color_1() }}">
    ...
    <div class="card m-b-30">
        <div class="card-header rounded" style="{{ background_color_2() }}">
            <h4 class="mt-2 text-dark">
                Créer un acheminement d'emballage
            </h4>
        </div>
    </div>
    ...
    <div class="row mt-2 mb-5">
        <div class="col-md-12">
            ...
            <div class="table-responsive mt-3">
                <div class="col-md-12">
                    <form action="{{ route('store.acheminer_emballage') }}" method="post" id="myForm">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3" id="table">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold" for="produit">Emballage</label>
                                            <div class="input-group input-group-sm mb-3">
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3" id="table">
                                    <legend class="float-none w-auto px-1">Détails acheminement</legend>
                            ...
                            <div class="modal-dialog g modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Souhaitez-vous vraiment confirmer ce acheminement ?
                                    </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <fieldset class="border p-3 rounded-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="" class="fw-bold">Total Nombre Qté à acheminer</label>
                                            <input class="form-control border-0" type="text" id="prixAchatTotal"
                                                readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" class="fw-bold">Nombre à acheminer</label>
