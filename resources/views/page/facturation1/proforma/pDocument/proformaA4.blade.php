...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">FACTURE PROFORMA</div>
    <br>
                ...
                <table class="tableInfo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $infoAgence->adresseAgence }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; font-style: italic; vertical-align: top;">Téléphone&nbsp;:</td>
                            <td>{{ $infoAgence->numero_telephone_1 }} / {{ $infoAgence->numero_telephone_2 }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-weight: bold; font-style: italic; vertical-align: top;">Id vendeur&nbsp;:
                            </td>
            ...
            <fieldset class="border p-3 rounded-3" style="border-radius: 5px;">
                ...
                <table class="tableInfo">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight: bold; font-style: italic ; vertical-align: top">Téléphone&nbsp;:
                            </td>
    ...
    <div style="margin-top: 0px;">
        ...
        <div style="margin-bottom: 10px;">
            <span style="font-weight: bold;">Validité:</span> {{ $infoFacture->Validite }}
        </div>
        ...
        <tbody>
            ...
            @forelse ($lignefacture as $ligne)
                @php
                    ...
                    $puNetTTC =$ligne->Prix_unitaire_TTC;
        ...
        if($ligne->Code_lettre == 'D'){
            ...
            $totalTVA_D += $MontantNetTTC - $MontantNetHT;
                ...
                <tr>
                    ...
                    <td>{{ number_format(intval($ligne->Qte), 0, ',', ' ') }}</td>
    ...
    <div class="container">
        ...
        <div>
            ...
            ({{ number_format($totalTTC + $aib, 0, ',', ' ') }}) francs CFA
        </div>
        ...
        <div align="right" style= "  ">{{ $infoVendeur->name }}</div>
