...
<body>
    ...
    <div class="titre" style="">LISTE PROFORMAS</div>
  ...
  <table class="tableLigne">
        <thead>
                <tr>
                    ...
                    <th style="width: 50px;background-color: #3232df;color: white;">N°</th>
                    ...
                    <th style="width: 50px;background-color: #3232df;color: white;">Validité</th>
                    <th style="background-color: #3232df;color: white;">AIB</th>
                    <th style="width: 100px;background-color: #3232df;color: white;">AIB à déduire</th>
                    <th style="background-color: #3232df;color: white;">Net à payer</th>
                </tr>
        </thead>
        <tbody>


            @foreach($data['tableFactureParPeriodeData'] as $proforma)
            @if (in_array($proforma['count'], [
            'Total général'

            ]))
            <tr>
                <td colspan="5" style="font-weight: bold;">{{ $proforma['count'] }}</td>
                <td colspan="2" style="text-align: right;font-weight: bold;">{{ $proforma['Date_facture']  }}</td>
