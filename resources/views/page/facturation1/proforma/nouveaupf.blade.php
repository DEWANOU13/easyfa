...
<section>
  ...
  <form id="formX" action="{{ route('storeProforma') }}" method="POST" class="my-5">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="btn-group w-100" role="group" aria-label="Basic radio toggle button group">
                <input type="radio" class="btn-check AibFacturer-select" disabled name="Aib" value="0" id="Aib0" checked>
                <label class="btn btn_aib" for="Aib0">NON</label>

                <input type="radio" class="btn-check AibFacturer-select" disabled name="Aib" value="1" id="Aib1">
    ...
    <div class="mb-5">
      <button id="validate-button" class="btn text-white d-block ms-auto" style="{{ background_color_1() }}" type="button">Valider</button>
    </div>
    <br>
      ...
      if (typeProduit === 'PRESTATION') {
        ...
        if (selectedAib == 5) {
          var removedAmount = pu_HT_net * quantity *
            0.05; // Calculer le montant de l'AIB à soustraire
