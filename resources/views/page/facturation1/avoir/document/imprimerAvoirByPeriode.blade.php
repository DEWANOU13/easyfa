...
<body>
    ...
    <div class="titre">LISTE DES FACTURES AVOIR SUR UNE PERIODE  </div>
    <div class="box0">
      ...
      <table class="tableLigne">
        <thead>
            <tr>
                ...
                <th width="20px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">
                    #</th>
        ...
        <tbody>
            @php
                $montantTotal = 0;
            @endphp
            @foreach($data['tableFactureParPeriodeData'] as $row)
