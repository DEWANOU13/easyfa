    ...
    <table class="tableLigne">
        ...
        if($ligne->Code_lettre == 'D'){
            ...
            <tr>
                ...
                @else
                <td>{{$ligne->Designation}} ({{$puNetTTC}}) X {{$ligne->Qte}} =</td>
    ...
    <div class="">
        <table class="tableLigne2" >
            <tbody>
                ...
                @if ($totalHTA > 0)
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">EXONERES:</td>
                ...
                @if ($totalHT_B > 0)
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">TOTAL&nbsp;HT&nbsp;[B]18%:</td>
                    <td align="right">{{number_format($totalHT_B, 0, ',', ' ') }} </td>
                </tr>
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">TOTAL&nbsp;TVA&nbsp;[B]18%:</td>
                    <td align="right">{{ number_format( intval($totalTVA_B), 0, ',', ' ') }}</td>
                </tr>
                @endif
                @if ($totalHT_C > 0)
                <tr>
                    <td style="font-weight: bold;font-size: 4px">TOTAL&nbsp;HT&nbsp;[C]0%:</td>
                ...
                @if ($totalHT_D > 0)
                <tr>
                    <td style="font-weight: bold;font-size: 4px">TOTAL&nbsp;HT&nbsp;[D]18%:</td>
                    <td align="right">{{number_format($totalHT_D, 0, ',', ' ')}}</td>
                </tr>
                <tr>
                    <td style="font-weight: bold;font-size: 4px">TOTAL&nbsp;TVA&nbsp;[D]18%: </td>
                    <td align="right">{{number_format( intval($totalTVA_D), 0, ',', ' ')}}</td>
                </tr>
                @endif
                @if ($totalHT_E > 0)
                <tr>
                    <td style="font-weight: bold;font-size: 4px">REGIME&nbsp;TPS[E]:</td>
                ...
                @if ($totalHT_F > 0)
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">RESERVES:</td>
                ...
                @if(strlen($infoFacture->Ifu_client) == 13)
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">Aib&nbsp;1%:</td>
                    <td align="right">{{number_format($aib, 0, ',', ' ')}}</td>
                </tr>
                @else
                <tr>
                    <td  style="font-weight: bold;font-size: 4px">Aib&nbsp;5%:</td>
                    <td align="right">{{number_format($aib, 0, ',', ' ')}}</td>
                </tr>
                @endif
                @endif
                @if (isset($infoTotal->Aib_deductible) && $infoTotal->Aib_deductible > 0)
                    <tr>
                         <td  style="font-weight: bold;font-size: 4px">Aib&nbsp;Déductible:</td>
                    ...
                    <tr>
                        <td  style="font-weight: bold;font-size: 4px">Net&nbsp;à&nbsp;payer:</td>
                       <td  align="right">{{number_format($totalTTC + $aib - $aibDeductible, 0, ',', ' ')}}</td>
                   </tr>
                <tr>
                    <td style="font-weight: bold;font-size: 4px">NBRE&nbsp;D'ARTICLES&nbsp;:</td>
