...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 40%;
            margin-top: 50px; /* Marge supérieure pour commencer après l'en-tête */
            margin-bottom: 10px;
        }
        .table-container2 {
            width: 50px;
       ...
       .tableLigne th {
        ...
        body::before {
            ...
            font-size: 6px; /* Ajustez la taille du texte selon vos besoins */
...
<div class="titre" style="padding-top: 8px;">FACTURE VENTE</div>

@endif
@if ($infoFacture->Code_type_facture == "FA")
<div class="titre" style="padding-top: 8px;">FACTURE AVOIR</div>
@endif
@if ($infoFacture->Code_type_facture == "EV")
<div class="titre" style="padding-top: 8px;">FACTURE VENTE A L'EXPORTATION</div>
...
<div class="container">
    <div class="container">
        <div class="box1">
            ...
            <div style="text-align: center; font-weight: bold ;font-size: 8px">{{$infoFacture->Code_signature}}</div>
            <div>
                <div class="box3" >
                ...
                <div class="box4" >
                    <table class="">
                        <tbody>
                            <tr>
                                <td style="font-weight: bold ;font-size: 7px">MECeF&nbsp;NIM:</td>
                                <td>{{$infoFacture->Nim_machine}}</td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold ;font-size: 7px">MECeF&nbsp;Compteurs:</td>
                                <td>{{$infoFacture->Compteur_type_facture}}/{{$infoFacture->Compteur_total}} {{$infoFacture->Code_type_facture}}</td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold ;font-size: 7px">MECeF&nbsp;Heure:</td>
        ...
        <div class="box2 right-align">
            <table class="tableInfox" align="right">
                <tbody>
                    <tr>
                        <td  style="font-weight: bold; font-size: 7px">TOTAL&nbsp;TTC:</td>
                        <td>{{number_format($totalTTC + $aib, 0, ',', ' ')}}</td>
                    </tr>
                    @if ($totalHTA > 0)
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">EXONERES:</td>
                    ...
                    @if ($totalHT_B > 0)
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">TOTAL&nbsp;HT&nbsp;[B]18%:</td>
                        <td>{{number_format($totalHT_B, 0, ',', ' ') }} </td>
                    </tr>
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">TOTAL&nbsp;TVA&nbsp;[B]18%:</td>
                        <td>{{ number_format( intval($totalTVA_B), 0, ',', ' ') }}</td>
                    </tr>
                    @endif
                    @if ($totalHT_C > 0)
                    <tr>
                        <td style="font-weight: bold;font-size: 7px">TOTAL&nbsp;HT&nbsp;[C]0%:</td>
                    ...
                    @if ($totalHT_D > 0)
                    <tr>
                        <td style="font-weight: bold;font-size: 7px">TOTAL&nbsp;HT&nbsp;[D]18%:</td>
                        <td>{{number_format($totalHT_D, 0, ',', ' ')}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;font-size: 7px">TOTAL&nbsp;TVA&nbsp;[D]18%: </td>
                        <td>{{number_format( intval($totalTVA_D), 0, ',', ' ')}}</td>
                    </tr>
                    @endif
                    @if ($totalHT_E > 0)
                    <tr>
                        <td style="font-weight: bold;font-size: 7px">REGIME&nbsp;TPS[E]:</td>
                    ...
                    @if ($totalHT_F > 0)
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">RESERVES:</td>
                    ...
                    @if(strlen($infoFacture->Ifu_client) == 13)
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">Aib&nbsp;1%:</td>
                        <td>{{number_format($aib, 0, ',', ' ')}}</td>
                    </tr>
                    @else
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">Aib&nbsp;5%:</td>
                        <td>{{number_format($aib, 0, ',', ' ')}}</td>
                    </tr>
                    @endif
                    @endif
                    ...
                    <tr>
                         <td  style="font-weight: bold;font-size: 7px">Aib&nbsp;Déductible:</td>
                    ...
                    <tr>
                        <td  style="font-weight: bold;font-size: 7px">Net&nbsp;à&nbsp;payer:</td>
                       <td>{{number_format($totalTTC + $aib - $aibDeductible, 0, ',', ' ')}}</td>
                   </tr>
                    <tr>
                        <td style="font-weight: bold;font-size: 7px">NBRE&nbsp;D'ARTICLES&nbsp;:</td>
                        <td>{{$nombreLignes}}</td>
                    </tr>
    ...
    <div align="right" style= "font-weight: bold;  margin-top: 60px; font-style: italic">SERVICE FACTURATION</div>
