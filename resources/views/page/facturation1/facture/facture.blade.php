                                                ...
                                                <tr style="cursor:pointer;" class="clickable-row "
                                                    ...
                                                    <td>
                                                        @if($proforma->Statut_facture == 'EN COURS')
                                                            <span class="status-en-cours">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                        @if($proforma->Statut_facture == 'NORMALISEE')
                                                            <span class="status-normalisee">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                        @if($proforma->Statut_facture == 'ANNULEE')
                                                            <span class="status-annulee">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                        @if($proforma->Statut_facture == 'INVALIDEE')
                                                        <span class="status-invalidee">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                        @if($proforma->Statut_facture == 'SOLDE')
                                                        <span class="status-solde">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                        @if($proforma->Statut_facture == 'EN COURS DE REGLEMENT')
                                                        <span class="status-en-cours-paiement">{{ $proforma->Statut_facture }}</span>
                                                        @endif
                                                    </td>
                                        ...
                                        <tbody>
                                            @forelse ($detailFactures as $detailFacture)
                                                @php
                                                    ...
                                                    $MontantNetHT = $MontantNetTTC / (1 + $detailFacture->valeur_taxe / 100);
                                                @endphp
                                                <tr>
                                    ...
                                    <form id="listeFacturePeriodeForm" action="{{ route('imprimerlisteFacture') }}"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="agence" type="text" class="form-select js-single  w-100"
                                                style="width: 100%;" id="agence4" required>
                                                <option></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="datetime-local" name="date_debut" id="dateDebut"
                                                ...
                                                aria-describedby="inputGroup-sizing-sm" max="{{ date('Y-m-d\TH:i') }}"
                                                required>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div>
                                                ...
                                                <select name="client" type="text" class="form-select js-single w-100"
                                                    style="width: 100%" id="client1" required>
                                                    <option value="Tous">Tous</option>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <fieldset class="border p-3 rounded-3">
                                ...
                                <div class="col-md-10 offset-md-1">
                                    <form id="form1" action="{{ route('statistiqueGlobalFacture') }}" method="GET"
                                        class="row gx-3 gy-2 d-flex align-items-center justify-content-center">
                                        @csrf
                                        <div class="col-md-2">
                                            <label class="" id="inputGroup-sizing-sm">Agence</label>
                                            <select name="agence" type="text" class="form-select js-single  w-100"
                                                style="width: 100%;" id="agence1" required>
                                                <option></option>
                                                {{--     @if (userAffectedSiege())
                                                    <option value="Tous" >Tous</option>
                                                    @endif --}}
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" class="btn text-white w-100 mt-4" id="AppliquerForm1"
                                                style="{{ background_color_1() }}">Appliquer</button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-10 offset-md-1">
                                    <form id="form2" action="{{ route('statistiqueDetailleFacture') }}"
                                        ...
                                        <div class="col-md-2">
                                            <label class="" id="inputGroup-sizing-sm">Agence</label>
                                            <select name="agence" type="text" class="form-select js-single  w-100"
                                                style="width: 100%;" id="agence3" required>
                                                <option></option>
                                                {{-- @if (userAffectedSiege())
                                                    <option value="Tous" >Tous</option>
                                                    @endif --}}
                                        ...
                                        <div class="col-md-2 ">
                                            ...
                                            <select name="taxe" type="text" class="form-select" id="taxe">
                                                <option value="Tous">Tous</option>
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" class="btn styleBtnDownload text-white w-100 mt-4"
                                                id="AppliquerForm2" style="{{ background_color_1() }}">Appliquer</button>
                                        </div>
                                    </form>
                                </div>
                            </fieldset>
                    ...
                    success: function(response) {
                        ...
                        categories.forEach(function(categorie) {
                            ...
                            ['FV', 'FA', 'EV', 'EA'].forEach(function(codeTypeFacture) {
                                ...
                                totalRow += `<td>${numberFormat(value.toFixed(0))}</td>`;
                                totals[codeTypeFacture] += parseFloat(
                                    value.toFixed(0)); // Ajouter à la somme totale
                            });
                        ...
                        categories.forEach(function(categorie, index) {
                            ...
                            var diffFV_FA = parseFloat(fv.toFixed(0)) - parseFloat(fa.toFixed(0));
                            var diffEV_EA = parseFloat(ev.toFixed(0)) - parseFloat(ea.toFixed(0));
                            var totalDiff = parseFloat(diffFV_FA.toFixed(0)) + parseFloat(
                                diffEV_EA.toFixed(0));
