...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">BORDEREAU APPROVISIONNEMENT EMBALLAGE</div>
    <br>
    @foreach ($appro_emballages as $approvisionnements)
                ...
                <table class="tableInfo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            Reférence&nbsp;:</td>
                            <td>{{ $approvisionnements->Reference_Appro_Emballage }}</td>
                        </tr>
                        <tr>
