@extends('layouts.master', ['title' => 'Approvisionner'])
@section('content')
    @include('layouts.partials.entete-page', [
        'infos1' => 'Approvisionner',
        'infos2' => 'Approvisionner',
        'infos3' => 'Liste',
    ])
        ...
        <div class="col text-end">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" style="z-index: 2000;">
                    @can('effectuer-approvisionnement')
                        <li><a class="dropdown-item" type="button" href="{{ route('nouveau_approvissionner') }}">Nouveau</a>
                        </li>
                    @endcan
                    <form action="{{ route('approvisionnement_imprimer_action') }}" method="POST" target="_blank">
                        @csrf
                        ...
                        <div class="col-md-2">
                            <div class="row border">
                                <form class="d-flex align-items-center mt-2" id="filterForm"
                                    action="{{ route('filterApprovisionnement') }}" method="GET">
                                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste des approvissionnements</h3>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($approvisionnements as $approvisionnement)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('get.approvisionner_by_approvisionnement', ['id' => $approvisionnement->id]) }}">
                                                        ...
                                                        <td class="entree-produit">
                                                            {{ $approvisionnement->Reference_Approvisionnement }}</td>
                                                        <td class="entree-produit">
                            ...
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Détails approvisionnements</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive responsive-1">
                                        <div class="col-md-12">
                                            <table id=""
                                                ...
                                                <tbody>
                                                    @if (isset($approvisionners))
                                                        @forelse($approvisionners as $approvisionner)
                                                            <tr style="cursor:pointer" class="clickable-row">
                                                                <td class="entree-produit">
                                                                ...
                                                                <td class="entree-produit"> {{ $approvisionner->Qte_Receptionnee }}</td>
                                                                <td class="entree-produit">  {{ $approvisionner->Qte_Approvisionnee - $approvisionner->Qte_Receptionnee}}</td>
                                                            </tr>
                                                        @empty
                                                        @endforelse
                                                    @endif
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            ...
                            <form class="row gx-3 gy-2 pb-4" method="POST" action="{{ route('imprimer-approv') }}"
                                target="_blank">
                                @csrf
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="categorie" type="text" class="form-select" id="categorie">
                                        <option value="Toutes">Toutes</option>
                                        @foreach (categorie_appros() as $categorie)
        ...
        $(document).ready(function() {
            ...
            $('#categorie').on('change', function() {
                ...
                if (selectedCategoryId) {
                    $.ajax({
                        url: '/get-produit-approvisionnement/', // URL à adapter selon tes routes
                        type: 'POST',
                        data: {
