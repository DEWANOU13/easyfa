@extends('layouts.master', ['title' => 'Réceptionner'])
@section('content')
        ...
        <div class="col text-end">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" style="z-index: 2000;">
                    @can('receptionner-approvisionnement')
                        <li><a class="dropdown-item" type="button"
                                href="{{ route('nouveau_reception_approvissionner') }}">Nouveau</a>
                        </li>
                    @endcan
                    <form action="{{ route('reception_approv_imprimer_action') }}" method="POST" target="_blank">
                        @csrf
                        ...
                        <div class="col-md-2">
                            <div class="row border">
                                <form class="d-flex align-items-center mt-2" id="filterForm"
                                    action="{{ route('filterReceptionAppro') }}" method="GET">
                                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste réception des approvisionnements</h3>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($receptions as $reception)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('get.receptionner_by_reception', ['id' => $reception->id]) }}">
                            ...
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Détails réceptions approvisionnements</h3>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            ...
                            <form class="row gx-3 gy-2 pb-4" method="POST"
                                action="{{ route('reception_approv_impression') }}" target="_blank">
                                @csrf
                                <div class="col-sm-6">
