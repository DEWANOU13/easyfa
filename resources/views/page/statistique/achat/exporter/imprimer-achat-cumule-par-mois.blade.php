...
@endif
<table>
    <th colspan="5" style="text-align: center; font-weight: bold; font-size: 20px;">ACHAT CUMULÉE PAR MOIS</th>
    <tbody>
        <tr></tr>
...
<table>
    <thead>
        <tr style="padding: 8px; border: 1px solid black; ">
            <th width="300px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; " scope="col">Période </th>
