...
<table>
    <thead>
        <tr style="padding: 8px; border: 1px solid black; ">
            <th width="300px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; " scope="col">Désignation Produit</th>
            <th width="300px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; " scope="col">Quantite</th>
...
<table>
    ...
    <tr>
        <td colspan="5" style="font-weight: bold;text-align: right;">Edite par ESAYFAC</td>
    </tr>
</table>
</body>
