...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">Achat cumulées par agence</div>
    <br>
    ...
    <div class="table">
        <table class="tableLigne">
            <thead>
                <tr>
                    <tr>
                        <th style="width: 10px;background-color: #3232df;color: white;">Désignation Produit</th>
                        <th  style="width: 10px;background-color: #3232df;color: white;">Quantite</th>
                        <th  style="width: 10px;background-color: #3232df;color: white;">Achat HT </th>
                        <th  style="width: 10px;background-color: #3232df;color: white;">TVA </th>
                        <th  style="width: 10px;background-color: #3232df;color: white;">AIB</th>
                        <th  style="width: 10px;background-color: #3232df;color: white;">Achat TTC</th>
                    </tr>
                </tr>
            </thead>
            <tbody>
        ...
        <table style="margin-top: 15px; width: 100%;">
            <tr>
                <td colspan="5" style="text-align: right;">Imprimé par {{ Auth::user()->name }}</td>
            </tr>
            <tr>
