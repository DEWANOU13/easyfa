...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">Achat cumulées par fournisseur</div>
    <br>
    ...
    <div class="table">
        <table class="tableLigne">
            <thead>
                <tr>
                    <th style="width: 10px;background-color: #3232df;color: white;">Raison&nbsp;sociale&nbsp;du&nbsp;client</th>
                    <th style="width: 10px;background-color: #3232df;color: white;">Fournisseur </th>
