...
@if ($reponse === 'list_facture_avoir')
    <table>
        <tr>
            <td colspan="5" style="text-align: center; font-weight: bold; font-size:18px;">LISTE DES FACTURES AVOIRS</td>
        </tr>
    </table>
        <table class="tableLigne">
            <tr>
                ...
                <th style="width:200px; background-color: #3232df;font-weight: bold; color: white; ">Reference Facture Origine</th>
...
@if ($reponse === 'sale_by_user')
    <table>
        <tr>
            <td colspan="5" style="text-align: center; font-weight: bold; font-size:18px;">STATISTIQUE EFFECTUER PAR UTILISATEUR</td>
        </tr>
    </table>
        <table class="tableLigne">
            <tr>
