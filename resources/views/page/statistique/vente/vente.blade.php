...
@section('content')
    ...
    <div class="d-flex justify-content-center">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            @can('statistique-vente-valeur-cumulee-jour')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_by_days' || $filtered == 'sale_by_days' || ($filtered == '' && old('filtered') == '')) active @endif" id="cumMois-tab" data-bs-toggle="tab"
                        data-bs-target="#cumMois" type="button" role="tab" aria-controls="cumMois"
                        aria-selected="true">Ventes Cumulées par jour
                    </button>
                </li>
            @endcan

            @can('statistique-vente-valeur-cumulee-categorie')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_by_category' || $filtered == 'sale_by_category') active @endif" id="cumCat-tab"
            ...
            @can('statistique-vente-valeur-cumulee-client')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_by_customer' || $filtered == 'sale_by_customer') active @endif" id="cumClient-tab"
                        data-bs-toggle="tab" data-bs-target="#cumClient" type="button" role="tab" aria-controls="cumClient"
                        aria-selected="false">Ventes Cumulées par
                        Client </button>
                </li>
            @endcan

            @can('statistique-vente-valeur-cumulee-produit')
                <li class="nav-item" role="presentation">
            ...
            @can('statistique-vente-valeur-cumulee-agence')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_by_agence' || $filtered == 'sale_by_agence') active @endif" id="cumAg-tab" data-bs-toggle="tab"
                        data-bs-target="#cumAg" type="button" role="tab" aria-controls="cumAg" aria-selected="false">Ventes
                        Cumulées par Agence </button>
                </li>
            @endcan

            @can('statistique-vente-valeur-journal-vente')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_log' || $filtered == 'sale_log') active @endif" id="jv-tab" data-bs-toggle="tab"
                        data-bs-target="#jv" type="button" role="tab" aria-controls="jv" aria-selected="false">Journal des
                        ventes </button>
                </li>
            @endcan

            @can('statistique-vente-valeur-facture-annulee-avoir')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'credit_note' || $filtered == 'credit_note') active @endif" id="FVA-tab" data-bs-toggle="tab"
                        data-bs-target="#FVA" type="button" role="tab" aria-controls="FVA" aria-selected="false">Facture
                        Annulée et leur Avoir </button>
                </li>
            @endcan

            @can('statistique-vente-valeur-facture-vente-utilisateur')
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (old('filtered') == 'sale_by_user' || $filtered == 'sale_by_user') active @endif" id="USER-tab" data-bs-toggle="tab"
                        data-bs-target="#USER" type="button" role="tab" aria-controls="USER" aria-selected="false">Facture
                        Vente par utilisateur </button>
                </li>
            @endcan
        </ul>
    </div>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        @can('statistique-vente-valeur-cumulee-jour')
            <div class="tab-pane fade @if (old('filtered') == 'sale_by_days' || $filtered == 'sale_by_days' || ($filtered == '' && old('filtered') == '')) show active @endif" id="cumMois" role="tabpanel"
                aria-labelledby="cumMois-tab">
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="d-flex mt-4">
                                            @can('statistique-vente-valeur-cumulee-jour-excel')
                                                <form action="">
                                                    <button type="button" id="printButtonJourExport"
                                                        class="btn m-2 btn-success">Exporter</button>
                                                </form>
                                            @endcan

                                            @can('statistique-vente-valeur-cumulee-jour-pdf')
                                                <form action="" method="">
                                                    <button type="button" id="printButtonJour"
                ...
                <div class="card m-b-30" style="margin-bottom: 150px;" wire:ignore>
                    <div class="card-header" style="{{ background_color_2() }}">
                        <h3 class="mt-2 d-inline-block text-dark">
                            Liste des ventes cumulées
                            @if ($ventes)
                                @if ($ag == 'Toutes')
                                    des agences
                                @else
                                    de l'agence {{ $ag->NomAgence }}
                                @endif
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="list_cumule_by_day" class="list_day tableInfo datatable table dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @if ($ventes)
                                        @foreach ($ventes as $vente)
                                            <tr>
                                                <td>{{ date('d-m-Y', strtotime($vente->date)) }}
                                                </td>
                                                <td>{{ number_format($vente->total_montant_ht, 0, '.', ' ') }}</td>
                                                <td>{{ number_format($vente->total_tva, 0, '.', ' ') }}</td>
                                                <td>{{ number_format($vente->total_montant_ttc, 0, '.', ' ') }}</td>
                                            </tr>
                                            @php
                                                $solde += $vente->total_montant_ttc;
                                            @endphp
                                        @endforeach
                                    @endif
                                    <tr>
        ...
        <div class="tab-pane fade @if (old('filtered') == 'sale_by_category' || $filtered == 'sale_by_category') show active @endif" id="cumCat" role="tabpanel"
                    ...
                    <div class="card-body">
                        <fieldset class="border p-3 rounded-3">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-4">
                                        @can('statistique-vente-valeur-cumulee-categorie-excel')
                                            <form action="">
                                                <button type="button" id="printButtonCategorieExport"
                                                    class="btn m-2 btn-success">Exporter</button>
                                            </form>
                                        @endcan
                                        @can('statistique-vente-valeur-cumulee-categorie-pdf')
                                            <form action="" method="">
            ...
            <div class="card m-b-30" wire:ignore>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="list_cumule_by_category"
                            class="list_category tableInfo datatable table dt-responsive nowrap"
                            style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead class="table-primary">
                                <tr>
                                ...
                                @if ($ventes_par_categorie)
                                    @foreach ($ventes_par_categorie as $vente_par_categorie)
                                        <tr>
                                            ...
                                            <td>{{ number_format($vente_par_categorie->total_montant_ht, 0, '.', ' ') }}
                                            </td>
                                            <td>{{ number_format($vente_par_categorie->total_tva, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_categorie->total_montant_ttc, 0, '.', ' ') }}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-4">
                                        ...
                                        @can('statistique-vente-valeur-cumulee-client-excel')
                                            <form action="">
                                        ...
                                        @endcan
                                        @can('statistique-vente-valeur-cumulee-client-pdf')
                                            <form action="" method="">
                                                @csrf
        ...
        <div class="tab-pane fade @if (old('filtered') == 'sale_by_product' || $filtered == 'sale_by_product') show active @endif" id="cumPro" role="tabpanel"
                    ...
                    <fieldset class="border p-3 rounded-3">
                        ...
                        <form action="{{ route('venteStatistiques') }}" method="POST">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-4">
                                        @can('statistique-vente-valeur-cumulee-produit-excel')
                                            <form action="">
                                        ...
                                        @can('statistique-vente-valeur-cumulee-produit-pdf')
                                            <form action="" method="">
                                                @csrf
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="list_cumule_by_product"
                            class="list_product tableInfo datatable table dt-responsive nowrap"
                            style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead class="table-primary">
                                <tr>
                            ...
                            <tbody>
                                @if ($ventes_par_produit)
                                    @foreach ($ventes_par_produit as $vente_par_produit)
                                        <tr>
                                            <td>{{ $vente_par_produit->Reference }} ==>
                                                {{ $vente_par_produit->Designation }}
                                            </td>
                                            <td>{{ number_format($vente_par_produit->total_quantite, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_produit->total_montant_ht, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_produit->total_tva, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_produit->total_montant_ttc, 0, '.', ' ') }}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select style="width:100%" name="agence" type="text"
                                        ...
                                        {{-- <option value="Toutes">Sélectionnez une agence</option> --}}
                                        <option value="{{ $agences->count() > 1 ? 'Toutes' : '' }}"
                                            {{ $agences->count() > 1 ? '' : 'hidden disabled' }}>Sélectionnez une agence
                                        </option>
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-4">
                                        @can('statistique-vente-valeur-cumulee-agence-excel')
                                            <form action="">
                                        ...
                                        @can('statistique-vente-valeur-cumulee-agence-pdf')
                                            <form action="" method="">
                                                @csrf
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select style="width:100%" name="agence" type="text"
                                        ...
                                        @endif --}}
                                        <option value="{{ $agences->count() > 1 ? 'Toutes' : '' }}"
                                            {{ $agences->count() > 1 ? '' : 'hidden disabled' }}>Toutes</option>
                                        @foreach ($agences as $key => $value)
                                            <option value="{{ $value->id }}">
                                                {{ $value->NomAgence }}
                                            </option>
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-4">
                                        @can('statistique-vente-valeur-facture-vente-utilisateur-excel')
                                            <form action="">
                                        ...
                                        @can('statistique-vente-valeur-facture-vente-utilisateur-pdf')
                                            <form action="" method="">
                                                @csrf
        ...
        {{-- agence --}}
        <div class="tab-pane fade @if (old('filtered') == 'sale_by_detail_agence' || $filtered == 'sale_by_detail_agence') show active @endif" id="cumDag" role="tabpanel"
            aria-labelledby="cumDag-tab">
            <div class="card m-b-30">
                <div class="card-body">
                    <fieldset class="border p-3 rounded-3">
                        <legend class="float-none w-auto px-1">Filtre</legend>
                        <form action="{{ route('venteStatistiques') }}" method="POST">
                            ...
                            <div class="row d-flex align-items-center">
                                <input name="filtered" type="hidden" class="form-control" id="filtered"
                                    value="sale_by_detail_agence">
                                <div class="col-md-3">
                                    <label class="form-label" for="date_debut_periode">Agence</label>
                                    <select name="agence" type="text" class="form-select" id="agence">
                                        <option value="">Sélectionnez une agence</option>
                                        @foreach (agences() as $key => $value)
                                            <option value="{{ $value->id }}">
                                                {{ $value->NomAgence }}
                                ...
                                <div class="col-md-3">
                                    <label class="form-label" for="date_debut_periode">Début Période</label>
                                    <input name="start_date_5" type="datetime-local"
                                        class="form-control {{ $errors->has('start_date_5') ? 'is-invalid' : '' }}"
                                        max="{{ date('d-m-Y') }}" id="start_date_5">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label" for="date_debut_periode">Fin Période</label>
                                    <input name="end_date_5" type="datetime-local"
                                        class="form-control {{ $errors->has('end_date_5') ? 'is-invalid' : '' }}"
                                        max="{{ date('d-m-Y') }}" id="end_date_5">
                                </div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableStatMagasin" class="tableInfo datatable table dt-responsive nowrap"
                            style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead class="table-primary">
                                <tr>
                                    <th scope="col">Désignation des agences
                                ...
                                @if ($ventes_par_agence)
                                    ...
                                    @foreach ($ventes_par_agence as $vente_par_agence)
                                        <tr>
                                            ...
                                            <td>{{ number_format($vente_par_agence->total_montant_ht, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_agence->total_tva, 0, '.', ' ') }}</td>
                                            <td>{{ number_format($vente_par_agence->total_montant_ttc, 0, '.', ' ') }}
                                            </td>
                        ...
                        <div class="card-body">
                            <fieldset class="border p-3 rounded-3">
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="d-flex mt-4">
                                            @can('statistique-vente-valeur-journal-vente-excel')
                                                <form action="">
                                            ...
                                            @can('statistique-vente-valeur-journal-vente-pdf')
                                                <form action="" method="">
                                                    @csrf
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3">
                                    <div class="d-flex mt-3">
                                        @can('statistique-vente-valeur-facture-annulee-avoir-excel')
                                            <form action="">
                                        ...
                                        @can('statistique-vente-valeur-facture-annulee-avoir-pdf')
                                            <form action="" method="">
                                                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function sendRequest(reponse, tableData) {
            ...
            function logTableContentCategory() {
                ...
                if (reponse === 'list_cumule_by_category') {
                    ...
                    $rows.each(function(index, row) {
                        ...
                        rowData.venteHT = $($cells[1]).text().trim();
                        rowData.tva = $($cells[2]).text().trim();
                        rowData.ventesTTC = $($cells[3]).text().trim();
            ...
            function logTableContentProduct() {
                ...
                if (reponse === 'list_cumule_by_product') {
                    ...
                    $rows.each(function(index, row) {
                        ...
                        // Définir les clés et les valeurs de l'objet rowData
                        rowData.designation = $($cells[0]).text().trim();
