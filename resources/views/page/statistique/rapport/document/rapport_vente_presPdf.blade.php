...
<body>
    ...
    <h2 style="text-align: center; text-transform: uppercase; text-decoration: underline">RAPPORT VENTE PRESTATION</h2>
    ...
    <table class="tableListe">
        ...
        <tbody>
            @foreach ($data['tableRapportPrestationData'] as $row)
