...
<body>
    ...
    <h2 style="text-align: center; text-transform: uppercase; text-decoration: underline">RAPPORT VENTE SANS MARGE</h2>
    ...
    <table class="tableListe">
        <thead>
            <tr>
                ...
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte Stokée</th>
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte vendue</th>
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte sortie</th>
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte entrée</th>
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte Restant</th>
 width="60px"
                <th width="60px"  style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Vente</th>
