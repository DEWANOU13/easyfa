...
<table>
    <tr>
        <td colspan="8" style="font-weight: bold; font-size: 15px;background-color: #3232df; text-align: center; color: white;">{{$texteEntetePied->entete}}</td>
    </tr>
</table>
...
<table>
    <tbody>
        <tr>
            ...
            <th colspan="8"  style="font-weight: bold; font-size: 20px; text-align: center;">RAPPORT DE VENTE SANS MARGE </th>
        </tr>
        <tr></tr>
        <tr>
 ...
 <table>
    <thead>
        <tr>
            ...
            <th width="100px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Quantité stokée</th>
            <th width="100px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Quantité vendue</th>
            <th width="100px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Quantité sortie</th>
            <th width="100px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Quantité entrée</th>
            <th width="100px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Qte restant</th>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="4" style="font-weight: bold;">{{ $row['Reference'] }}</td>
        ...
        <tr>
            ...
            <td width="100px" style="">{{ $row['TotalEntree'] }}</td>
            <td width="100px" style="">{{ $row['Quantite'] }}</td>
            <td width="100px" style="">{{ $row['Quantite_Sorties'] }}</td>
            <td width="100px" style="">{{ $row['Quantite_Entrees'] }}</td>
            <td width="100px" style="">{{ $row['QuantiteRestant'] }}</td>
        ...
        <tr>
            <td  colspan="8" style="text-align: right; font-weight: bold;">{{\Carbon\Carbon::now()->format('d/m/Y à H:i:s')}}</td>
        </tr>
        <tr>
