...
<body>
    ...
    <h2 style="text-align: center; text-transform: uppercase; text-decoration: underline; margin-top: 100px">MARGE PAR MOIS</h2>
        ...
        <fieldset class="border p-3 rounded-3" style="border-radius: 5px;">
          ...
          <table class="tableInfo">
            <tbody>
              ...
              <tr>
                <td style="font-weight: bold; font-style: italic; vertical-align: top;">Période&nbsp;:</td>
    ...
    <table class="tableListe">
        <thead>
            <tr>
                ...
                <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Mois</th>
        ...
        <tbody>
            @foreach ($data['tableMargeParMoisData'] as $row)
