...
<body>
    ...
    <h2 style="text-align: center; text-transform: uppercase; text-decoration: underline; margin-top: 100px">MARGE PAR CLIENT</h2>
    ...
    <table class="tableListe">
        <thead>
            <tr>
                ...
                <th style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Dénomation sociale</th>
        ...
        <tbody>
            @foreach ($data['tableMargeParClientData'] as $row)
            @if (in_array($row['Denomination_sociale'], [
                'TOTAL',

            ]))
            <tr>
                <td style="text-align: right; font-weight: bold;">{{ $row['Denomination_sociale'] }}</td>
                ...
                <tr>
                    ...
                    <td  style="">{{ $row['Denomination_sociale'] }}</td>
