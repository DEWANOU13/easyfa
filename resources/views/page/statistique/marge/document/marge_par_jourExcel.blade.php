...
<table>
    <tbody>
        <tr>
            ...
            <th colspan="5"  style="font-weight: bold; font-size: 20px; text-align: center;">MARGE PAR JOUR </th>
        </tr>
        <tr></tr>
        <tr>
...
<table>
    <thead>
        <tr>
            ...
            <th width="200px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Date</th>
    ...
    <tbody>
        @foreach($tableMargeParJourData as $row)
        @if (in_array($row['Date'], [
            'TOTAL POUR CETTE PERIODE',
