...
<body>
    ...
    <h2 style="text-align: center; text-transform: uppercase; text-decoration: underline; margin-top: 100px">MARGE PAR JOUR </h2>
    ...
    <table class="tableListe">
        ...
        <tbody>
            @foreach ($data['tableMargeParJourData'] as $row)
