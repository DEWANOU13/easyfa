...
<table>
    <tbody>
        <tr>
            ...
            <th colspan="5"  style="font-weight: bold; font-size: 20px; text-align: center;">MARGE PAR CLIENT </th>
        </tr>
        <tr></tr>
        <tr>
...
<table>
    <thead>
        <tr>
            ...
            <th width="200px" style="background-color: #3232df;font-weight: bold; text-align: center; color: white; ">Dénomination sociale</th>
    ...
    <tbody>
        @foreach($tableMargeParClientData as $row)
        ...
        <tr>
            ...
            <td width="200px">{{ $row['Denomination_sociale'] }}</td>
