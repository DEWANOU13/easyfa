        ...
        <div class="col text-end">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" style="z-index: 2000;">
                    @can('effectuer-acheminement')
                        <li><a class="dropdown-item" type="button" href="{{ route('nouveau_acheminer') }}">Nouveau</a>
                        </li>
                    @endcan
                    <form action="{{ route('acheminement_imprimer_action') }}" method="POST" target="_blank">
                        @csrf
                        ...
                        <div class="col-md-2">
                            <div class="row border">
                                <form class="d-flex align-items-center mt-2" id="filterForm"
                                    action="{{ route('filterAcheminement') }}" method="GET">
                                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="card m-b-30 my-3">
                                <div class="card-header" style="{{ background_color_2() }}">
                                    <h3 class="mt-2  d-inline-block text-dark">Liste des acheminements</h3>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($acheminements as $acheminement)
                                                    <tr style="cursor:pointer" class="clickable-row"
                                                        data-url="{{ route('get.acheminer_by_acheminement', ['id' => $acheminement->id]) }}">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                    ...
                    <div class="row my-4">
                        <div class="col-md-8 offset-md-2 mb-5">
                            <h3>LISTE DES ACHEMINEMENTS SUR UNE PERIODE</h3>
                            <form class="row gx-3 gy-2 pb-4" method="POST"
                                action="{{ route('imprimer_acheminement') }}" target="_blank">
                                @csrf
                                <div class="col-sm-6">
