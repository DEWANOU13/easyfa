...
<body>
    ...
    <div class="titre" style="padding-top: 20px;">BORDEREAU ACHEMINEMENT</div>
    <br>
    @foreach ($acheminement as $item)
                ...
                <table class="tableInfo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($item->Date_acheminement)->format('d/m/Y H:i') }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; font-style: italic; vertical-align: top;">
                            Reférence&nbsp;:</td>
                            <td>{{ $item->Reference_acheminement }}</td>
                        </tr>
                        <tr>
                ...
                <tbody>
                    @foreach ($acheminer as $value)
                        <tr>
                            ...
                            <td>{{ $value->Qte_acheminee - $value->Qte_Receptionnee}}</td>
                        </tr>
                    @endforeach
