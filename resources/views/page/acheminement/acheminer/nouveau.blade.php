...
@section('content')
    ...
    @include('layouts.partials.entete-page', [
        'infos1' => 'Nouveau acheminement',
        'infos2' => 'Nouveau acheminement',
        'infos3' => 'Nouveau',
    ])

    <div class="d-flex flex-row-reverse bd-highlight">
        <div class="dropdown mb-2">
            <a href="{{ route('acheminer') }}" class="btn text-white" style="{{ background_color_1() }}">
    ...
    <div class="row mt-2 mb-5">
        <div class="col-md-12">
            ...
            <div class="table-responsive mt-3">
                <div class="col-md-12">
                    <form action="{{ route('store.acheminer') }}" method="post" id="myForm">
                        @csrf
                        @if ($errors->any())
        ...
        $(document).ready(function() {
            ...
            function updateOrAddRow(reference, designation, magasin, quantite, quantity_transfer) {
                ...
                if (quantite < quantity_transfer) {
                    alert('La quantité à acheminer est supérieure à la quantité disponible en stock.');
                    return false;
                }
