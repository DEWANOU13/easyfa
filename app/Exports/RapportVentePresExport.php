...
class RapportVentePresExport implements FromView
{
    ...
    {
        return view('page.statistique.rapport.document.rapport_vente_presExcel', [
            'tableRapportPrestationData' => $this->data['tableRapportPrestationData'],
